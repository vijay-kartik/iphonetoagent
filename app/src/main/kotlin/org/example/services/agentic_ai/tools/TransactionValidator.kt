...
object TransactionValidator: Tool<TransactionArgs, ToolResult.Boolean>() {
    ...
    override val descriptor: ToolDescriptor = ToolDescriptor(
        ...
        requiredParameters = listOf(
            ...
            ToolParameterDescriptor(name = "account_name", description = "Name of the account from where the amount has been debited from or credited into", type = ToolParameterType.String)
        )
    )
